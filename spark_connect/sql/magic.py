...
from spark_connect.config.builder import ConfigBuilder
from spark_connect.exceptions import UnconfigurableError
...
class SparkMagic(Magics):
    ...
    ENV_MASTER_MODE = "SPARK_CONNECT_SQL_MODE"
    DEFAULT_MODE = "local"
